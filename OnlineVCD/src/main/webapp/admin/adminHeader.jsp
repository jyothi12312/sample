...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String email=session.getAttribute("email").toString(); %>
            <center><h2>Online VCD System</h2></center>
            ...
            <a href="addVcdStoreDetails.jsp">Add VCD Store Details <i class='fas fa-plus-square'></i></a>
            <a href="allVcdStoreDetails.jsp">All VCD Store Details <i class='fas fa-plus-square'></i></a>
